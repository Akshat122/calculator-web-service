 ...
 * 
 */
@WebServiceClient(name = "CalculatorWebService", targetNamespace = "http://javawebservices.akshatkhanna.com/", wsdlLocation = "http://localhost:8080/WS_Demo/CalculatorWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWEBSERVICE_QNAME = new QName("http://javawebservices.akshatkhanna.com/", "CalculatorWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WS_Demo/CalculatorWebService?WSDL");
    ...
    public CalculatorWebService getCalculatorWebServicePort() {
        return super.getPort(new QName("http://javawebservices.akshatkhanna.com/", "CalculatorWebServicePort"), CalculatorWebService.class);
    }
    ...
    public CalculatorWebService getCalculatorWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://javawebservices.akshatkhanna.com/", "CalculatorWebServicePort"), CalculatorWebService.class, features);
    }
